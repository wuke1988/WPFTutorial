...
namespace _4IHandlerForLanguageChange
{
    public class MyBootstrapper: BootstrapperBase
    {
        ...
        protected override void Configure()
        {
            ...
            //如果还有自己的部件都加在这个地方
            batch.AddExportedValue<IResourceTask>(new ResourceTask());
            ...
            _container.ComposeParts(_container.GetExportedValue<IResourceTask>());
        }
        //根据传过来的key或名称得到实例
